...
class webserver:
    ...
    def __init__(self, external_loop,request_timeout=3, max_concurrency=3, backlog=16, debug=False):
        ...
        Keyword arguments:
            ...
            external_loop   - outside loop for cooperate with other coroutine
        """
    ...
    def run(self, host="127.0.0.1", port=8081, loop_forever=False):
